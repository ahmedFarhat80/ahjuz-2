...
var KTModalUpdateadmin = function() {
    ...
    return {
        init: function() {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_update_admin")),
            r = document.querySelector("#kt_modal_update_admin_form"),
            t = r.querySelector("#kt_modal_update_admin_submit"),
            e = r.querySelector("#kt_modal_update_admin_cancel"),
            o = r.querySelector("#kt_modal_update_admin_close"),
