"use strict";
var KTModalgovernoratesAdd = function() {
    var t, e, o, n, r, i;
    return {
        init: function() {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_add_governorate")),
            r = document.querySelector("#kt_modal_add_governorate_form"),
            t = r.querySelector("#kt_modal_add_governorate_submit"),
            e = r.querySelector("#kt_modal_add_governorate_cancel"),
            o = r.querySelector("#kt_modal_add_governorate_close"),
