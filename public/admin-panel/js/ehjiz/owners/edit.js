...
var KTModalUpdateowner = function() {
    var t, e, o, n, r, i;
    return {
        init: function() {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_update_owner")),
            r = document.querySelector("#kt_modal_update_owner_form"),
            t = r.querySelector("#kt_modal_update_owner_submit"),
            e = r.querySelector("#kt_modal_update_owner_cancel"),
            o = r.querySelector("#kt_modal_update_owner_close"),
