"use strict";
var KTModalownersAdd = function() {
    var t, e, o, n, r, i;
    return {
        init: function() {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_add_owner")),
            r = document.querySelector("#kt_modal_add_owner_form"),
            t = r.querySelector("#kt_modal_add_owner_submit"),
            e = r.querySelector("#kt_modal_add_owner_cancel"),
            o = r.querySelector("#kt_modal_add_owner_close"),
