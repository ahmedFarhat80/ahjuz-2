"use strict";
var KTModaladsAdd = function() {
    var t, e, o, n, r, i;
    return {
        init: function() {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_add_ad")),
            r = document.querySelector("#kt_modal_add_ad_form"),
            t = r.querySelector("#kt_modal_add_ad_submit"),
            e = r.querySelector("#kt_modal_add_ad_cancel"),
            o = r.querySelector("#kt_modal_add_ad_close"),
