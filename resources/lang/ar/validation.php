...
return [
    ...
    'attributes' => [
        ...
        'area'                  => 'المساحة',
        'opens_at'              => 'وقت الدخول',
        'closes_at'             => 'وقت الخروج',
        'imgs'                  => 'الصور',
        'governorate_id'        => 'المحافظة',
        'region_id'             => 'المنطقة',
        'address_details'       => 'تفاصيل العنوان',
        'insurance_price'       => 'مبلغ الـتأمين',
        'type'       => 'نوع القسم',
        'for'       => 'المكان مخصص',
        'starts_at' => 'البدء',
        'ends_at' => 'الإنتهاء', 
        'value' => 'القيمة', 
        'max_use_count' => 'أقصى عدد مرات الاستخدام', 

        'day_price' => 'سعر اليوم العادي', 
        'thursday_price' => 'سعر اليوم الخميس', 
        'friday_price' => 'سعر اليوم الجمعة',

        'rating' => 'التقييم', 
        'code' => 'الرمز', 
        'details' => 'التفاصيل', 
 
        'main_headline' =>'النص الرئيسي',
        'main_text' => 'النص الفرعي',
        'mobile_headline' => 'النص الرئيسي لتطبيقات الهاتف',
        'mobile_text' => 'النص الفرعي  لتطبيقات الهاتف',
        'address' => 'العنوان',
        'phone' => 'الهاتف',
        'whatsapp_1' => 'واتساب1',
        'whatsapp_2' => 'واتساب2',
        'footer_text' => 'نص النهاية',
