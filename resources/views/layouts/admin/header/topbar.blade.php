<div class="d-flex align-items-stretch flex-shrink-0 mt-3">
  ...
  <div class="d-flex align-items-center flex-shrink-0">
    ...
    @php
        ...
        $count_messages_notifications = auth_admin()->notifications()->whereNull('read_at')->count();
    @endphp
    ...
    <div class="symbol d-flex align-items-center h-40px">
            ...
            <div class="tab-pane fade show active" id="kt_topbar_notifications_3" role="tabpanel">
              ...
              <div class="scroll-y mh-325px my-5 px-8" id="ul_notifications">
                @if ($notifications->isNotEmpty())
                  @foreach ($notifications->where('type', 'App\Notifications\PropertyIsCreatedNotification') as $notification)
                    <div class="d-flex flex-stack py-4">
                      <div class="d-flex align-items-center me-2">
                        ...
                        <a href="{{ route('admin.properties.show', $notification->data['property_id']) }}" class="text-gray-800 text-hover-primary fw-bold">طلب موافقة على وحدة جديدة</a>
                      </div>
              ...
              <div class="py-3 text-center border-top">
                <a href="{{ route('admin.notifications.index') }}" class="btn btn-color-gray-600 btn-active-color-primary">جميع الإشعارات
      ...
      <!--end::Notifications-->
      <span id="count_notifications" class="symbol-badge badge badge-circle bg-danger start-0" @if (!$count_messages_notifications) style="display: none;" @endif >{{ $count_messages_notifications }}</span>
    </div>
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
      ...
      <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
        <img src="{{ auth_admin()->avatar }}" alt="metronic" />
      </div>
      <!--begin::Menu-->
      <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
        ...
        <div class="menu-item px-3">
          <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
              <div class="fw-bolder d-flex align-items-center fs-5">{{ auth_admin()->name }}
            </div>
              <a href="#" class="fw-bold text-muted text-hover-primary fs-7" dir="ltr">{{ auth_admin()->email }}</a>
            </div>
            <!--end::Username-->
          </div>
        </div>
        ...
        <div class="menu-item px-5 my-1">
          <a href="{{ route('admin.profile') }}" class="menu-link px-5">إعدادات الحساب</a>
        </div>
        <!--end::Menu item-->
        <!--begin::Menu item-->
