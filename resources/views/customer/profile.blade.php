                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                <div class="col-md-2 col-12 p-3 user_avatar">
                                    <img src="{{ auth_customer()->avatar }}" class="w-100 rounded" style="height: 180px">
                                    @error('file')
                                    ...
                                    <input type="file" name="avatar" value="{{ auth_customer()->avatar }}" class="d-none" onchange="readURL(this)">
                                </div>
                                <div class="col-md-10 col-12 pt-3">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-4">
                                            <label for="#"> الاسم الأول </label>
                                            <input type="text" class="form-control mt-1 bg-white shadow-sm" name="first_name" value="{{ old('first_name') ?? auth_customer()->first_name }}" style="font-weight: 500;">
                                            @error('first_name')
                                                <span class="invalid-feedback d-block mt-1 mb-5" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 col-12 mb-4">
                                            ...
                                            <input type="text" class="form-control mt-1 bg-white shadow-sm" name="last_name" value="{{ old('last_name') ?? auth_customer()->last_name }}" style="font-weight: 500;">
                                            @error('last_name')
                                                <span class="invalid-feedback d-block mt-1 mb-5" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 col-12 mb-4">
                                            ...
                                            <input type="text" class="form-control mt-1 bg-white shadow-sm" name="email" value="{{ old('email') ?? auth_customer()->email }}" style="font-weight: 500;direction: ltr;text-align: end;">
                                            @error('email')
                                                <span class="invalid-feedback d-block mt-1 mb-5" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6 col-12 mb-4">
                                            ...
                                            <div class="d-flex shadow-sm mt-1 text-start overflow-hidden position-relative" style="border: 1px solid #bdbdbd; border-radius: 0.25rem;">
                                                <input dir="ltr" type="tel" name="phone" id="phone" class="form-control border-0 bg-none" placeholder="" value="{{ old('phone') ?? auth_customer()->phone }}">
                                        ...
                                        <div class="col-12 mb-4">
                                            ...
                                            <input type="text" class="form-control mt-1 bg-white shadow-sm" name="address" value="{{ old('address') ?? auth_customer()->address }}" style="font-weight: 500;">
                                            @error('address')
