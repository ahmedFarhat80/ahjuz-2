...
<div class="modal fade" id="kt_modal_update_admin" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered mw-650px">
    ...
    <div class="modal-content">
      <!--begin::Form-->
      <form class="form"  novalidate="novalidate" action="{{ route('admin.admins.update', $admin->id) }}" id="kt_modal_update_admin_form" enctype="multipart/form-data">
        @method('PUT')
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_update_admin_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">تحديث بيانات المشرف</h2>
          <!--end::Modal title-->
          <!--begin::Close-->
          ...
          <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_admin_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_admin_header" data-kt-scroll-wrappers="#kt_modal_update_admin_scroll" data-kt-scroll-offset="300px" style="max-height: 52px;">
              ...
              <div class="mb-7">
                ...
                <div class="mt-1 fv-row">
                  <!--begin::Image input-->
                  <div class="image-input image-input-outline {{ $admin->getRawOriginal('avatar') ? '' : 'image-input-empty' }}" data-kt-image-input="true" style="background-image: url({{ asset('frontend/img/avatar.png') }})">
            ...
            <div class="fv-row mb-7 fv-plugins-icon-container">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control form-control-solid" name="name" value="{{ $admin->name }}" placeholder="أدخل الاسم" required autocomplete="off">
              <!--end::Input-->
            ...
            <!--end::Input group-->
              ...
              <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-solid" name="phone" value="{{ $admin->phone }}" placeholder="أدخل رقم الهاتف" required>
                <!--end::Input-->
              </div>
              <!--end::Input group-->
            <!--begin::Input group-->
            <div class="fv-row mb-7 fv-plugins-icon-container">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="email" class="form-control form-control-solid" dir="auto" value="{{ $admin->email }}" direction="auto" name="email" placeholder="أدخل البريد الإلكتروني" required>
              <!--end::Input-->
            <div class="fv-plugins-message-container invalid-feedback"></div></div>
            <!--end::Input group-->
        ...
        <div class="modal-footer flex-center">
          <!--begin::Button-->
          <button type="reset" id="kt_modal_update_admin_cancel" class="btn btn-light me-3">تجاهل</button>
          <!--end::Button-->
          <!--begin::Button-->
          <button type="submit" id="kt_modal_update_admin_submit" class="btn btn-primary">
            <span class="indicator-label">تحديث المشرف</span>
