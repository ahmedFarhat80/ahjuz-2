...
<div class="d-flex flex-column flex-root">
	...
	<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed">
		...
		<div class="d-flex flex-center flex-column flex-column-fluid p-10 p-lg-15">
			<!--begin::Logo-->
			<a href="/" class="mb-12">
				<img alt="Logo" src="{{ asset('frontend/img/logo.png') }}" class="h-50px" />
			</a>
			<!--end::Logo-->
			<!--begin::Wrapper-->
			<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
				...
				<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('admin.login') }}" method="POST">
					...
					<div class="fv-row mb-10">
						...
						<!--end::Label-->
						<!--begin::Input-->
						<input class="form-control form-control-lg form-control-solid" dir="ltr" type="text" name="email" autocomplete="off" value="{{ old('email')}}" required autofocus/>
						<!--end::Input-->
					</div>
					<!--end::Input group-->
					<!--begin::Input group-->
					<div class="fv-row mb-10">
						...
						<!--begin::Input-->
						<input class="form-control form-control-lg form-control-solid" dir="ltr" type="password" name="password" autocomplete="off" required/>
						<!--end::Input-->
					</div>
					<!--end::Input group-->
