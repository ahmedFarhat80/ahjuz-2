<div class="flex-lg-row-fluid ms-lg-15">
  ...
  <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8 justify-content-between">
    ...
    <!--begin:::Tab item-->
    <li class="nav-item">
      <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ad_view_overview_tab">تعديل الإعلان</a>
    </li>
        ...
        <div class="menu-item px-5">
          <form method="POST" action="{{ route('admin.ads.destroy', $ad->id) }}">
            ...
            <div class="menu-item px-3">
              <button onclick="destroy(event)" type="submit" class="btn btn-link text-danger">حذف الإعلان</button>          
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="tab-content" id="myTabContent">
    <!--begin:::Tab pane-->
    <div class="tab-pane fade show active" id="kt_ad_view_overview_tab" role="tabpanel">
      <!--begin::Card-->
        ...
        <div class="card-body pt-0 pb-5">
          <form action="{{ route('admin.ads.update', $ad->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12 mb-10 text-center">
              <img class="img-thumbnail" src="{{ $ad->cover }}" alt="" width="100" height="100">
            </div>
            <div class="row">
              <div class="col-md-6 mb-10">
                <label class="form-label">الرابط</label>
                <input type="text" name="url" value="{{ old('url') ?? $ad->url }}" class="form-control form-control-solid"/>
                @error('url')
            ...
            <button class="btn btn-primary">تحديث الإعلان</button>
          </form>
        </div>
