  ...
  <div class="card mb-5 mb-xl-8">
    ...
    <div class="card-body pt-15">
      ...
      <div class="d-flex flex-center flex-column mb-5">
        ...
        <!--end::Avatar-->
        <!--begin::Name-->
        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-7">{{ $customer->full_name }}</a>
        <!--end::Name-->
        {{-- <!--begin::Position-->
        ...
        <div class="d-flex flex-wrap flex-center">
          ...
          <div class="border border-success rounded py-3 px-3 mx-2 mb-3">
            <div class="fs-4 fw-bolder text-gray-700 text-center">
              <span class="w-75px">{{ number_format($customer->bookings_sum_subtotal_price - $customer->bookings_sum_discount) }}</span>
            </div>
          ...
          <div class="border border-primary rounded py-3 px-3 mx-2 mb-3">
            <div class="fs-4 fw-bolder text-gray-700 text-center">
              <span class="w-50px">{{ $bookings->count() }}</span>
            </div>
      ...
      <div class="d-flex flex-stack fs-4 py-3">
        ...
        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="تعديل بيانات الزبون">
          <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_customer">تعديل</a>
        </span>
      </div>
      <!--end::Details toggle-->
      ...
      <div id="kt_customer_view_details" class="collapse show">
        <div class="py-5 fs-6">
          ...
          <div class="text-gray-600" dir="ltr" style="text-align: right">{{ $customer->address }}</div>

          <div class="fw-bolder mt-5">رقم الهاتف</div>
          <div class="text-gray-600">&#x200E;{{ country_code($customer->phone) }}</div>
          
          <div class="fw-bolder mt-5">البريد الالكتروني</div>
          <div class="text-gray-600">
            <a href="#" class="text-gray-600 text-hover-primary text-end" dir="ltr">{{ $customer->email }}</a>
          </div>
        </div>
      </div>
      <!--end::Details content-->
