...
<div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
    <!--begin::Add owner-->
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_owner">إنشاء مالك جديد</button>      
    <!--end::Add owner-->
</div>

<div class="modal fade" id="kt_modal_add_owner">
  <!--begin::Modal dialog-->
  <div class="modal-dialog modal-dialog-centered mw-650px">
    <!--begin::Modal content-->
    <div class="modal-content">
      <!--begin::Form-->
      <form class="form" novalidate="novalidate" action="{{ route('admin.owners.store') }}" id="kt_modal_add_owner_form" method="POST">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_owner_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">إنشاء مالك جديد</h2>
          <!--end::Modal title-->
            <!--begin::Close-->
            <div id="kt_modal_add_owner_close" class="btn btn-icon btn-sm btn-active-icon-primary">
        ...
        <div class="modal-body py-10 px-lg-17">
          <!--begin::Scroll-->
          <div class="scroll-y me-n7 pe-7" id="kt_modal_add_owner_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_owner_header" data-kt-scroll-wrappers="#kt_modal_add_owner_scroll" data-kt-scroll-offset="300px" style="max-height: 62px;">
            <!--begin::Input group-->
        ...
        <div class="modal-footer flex-center">
          <!--begin::Button-->
          <button type="reset" id="kt_modal_add_owner_cancel" class="btn btn-light me-3">تجاهل</button>
          <!--end::Button-->
          <!--begin::Button-->
          <button type="submit" id="kt_modal_add_owner_submit" class="btn btn-primary">
            <span class="indicator-label">إنشاء المالك</span>
